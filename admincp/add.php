      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <?php
            if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['addPost'])){
                ...
                $post->setPostValue($_POST['title'], $_POST['link'],$_POST['desc'], $image, $_POST['category'] , "add");
                $post->DisplayError();
            }
          ?>
      </div>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <h1 class="page-header"><i class="glyphicon glyphicon-play"></i> اضافة فيديو جديد</h1>
      <div class="col-md-12">
          <div class="row">
            <div class="col-md-10">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" class="form-control" name="title" value="<?php echo isset($_POST['title']) ? $_POST['title'] : '' ?>" id="title" placeholder="ادخل عنوان للفيديو">
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-6">
                    <button type="submit" name="addPost" class="btn btn-block btn-success">اضافة الفيديو</button>
                </div>
              </div>
            </form>
            </div>
