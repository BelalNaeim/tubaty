         ...
         <div class="col-md-8">
          ...
          <div class="col-md-4">
            <div class="panel panel-danger">
              <div class="panel-heading">
                <h3 class="panel-title text-center">الفيديوهات</h3>
              </div>
              <div class="panel-body">
                  <h1 class="pull-right" style="color: #204d74"><i class="glyphicon glyphicon-film"></i> </h1>
          ...
          <table class="table table-hover">
              ...
              ?>
                  <tr class="text-center">
                      ...
                      <td><a href="../video.php?v=<?php echo $row['link'] ?>" class="btn btn-sm btn-info">مشاهده</a></td>
                    ...
                    <table class="table table-hover">
                        ...
                        ?>
                            <tr class="text-center">
                                ...
                                <td><a href="../video.php?v=<?php echo $post->getLinkPostById($row['post_id']); ?>" class="btn btn-sm btn-info" target="_blank">مشاهده</a></td>
