...
<title>الفيديوهات - <?php echo SITENAME ?></title>
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <h1 class="page-header"><i class="glyphicon glyphicon-film"></i> الفيديوهات</h1>
      <div class="col-md-12">
          <div class="row">
              <div class="col-md-12">
                    ...
                    <table class="table table-hover">
                        ...
                        ?>
                            <tr class="text-center">
                                ...
                                <td><a href="../video.php?v=<?php echo $row['link'] ?>" class="btn btn-sm btn-info" target="_blank">مشاهده</a></td>
