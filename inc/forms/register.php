<form
    ...
    method="POST" class="form-horizontal" style="padding: 15px;
    background: #fff;
    margin-bottom: 15px;
    border-radius: 5px;
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control"
                value="<?php echo isset($_POST['farstname']) ? $_POST['farstname']: null; ?>"
                name="farstname" id="farstname" placeholder="ادخل الاسم الاول">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control"
                ...
                name="lastname" id="lastname" placeholder="ادخل الاسم الاخير">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="email" class="form-control"
                ...
                name="email" id="email" placeholder="ادخل البريد الالكتروني">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="password" class="form-control"
                ...
                name="password" id="password" placeholder="ادخل كلمة المرور">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="password" class="form-control"
                value="<?php echo isset($_POST['confirm']) ? $_POST['confirm']: null; ?>"
                name="confirm" id="confirm" placeholder="ادخل تأكيد كلمة المرور">
        </div>
    </div>
